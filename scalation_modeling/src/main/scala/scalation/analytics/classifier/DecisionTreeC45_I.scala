...
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `DecisionTreeC45_I` class implements a Decision Tree classifier using the
 ...
 *  This version takes integer values for the data matrix.
 ...
 */
class DecisionTreeC45_I (val x: MatriI, val y: VectoI, fn: Array [String], isCont: Array [Boolean],
      ...
      extends ClassifierInt (x, y, fn, k, cn)
{
    ...
    {
        var next = new MutableList [DecisionTreeC45_I#Node] ()
    ...
    private var root: DecisionTreeC45_I#Node = null    // decision tree, store according to layers of tree
    ...
    def buildTree (opt: Tuple2 [Int, Double])
    {
        ...
        for (i <- 0 until vc(opt._1)) {
            ...
            if (flag) {
                ...
                var subtree = new DecisionTreeC45_I (next._1, next._2, fn, isCont, k, cn, vc)
                subtree.train ()
    ...
    def printTree ()
    {
        ...
        var queue = new Queue [DecisionTreeC45_I#Node] ()
        queue += root
...
} // DecisionTreeC45_I class


//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** `DecisionTreeC45_I` is the companion object for the `DecisionTreeC45_I` class.
 */
object DecisionTreeC45_I
{
    //:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    ...
    def apply (xy: MatriI, fn: Array [String], isCont: Array [Boolean], k: Int, cn: Array [String],
              vc: VectoI = null) =
    {
        new DecisionTreeC45_I (xy(0 until xy.dim1, 0 until xy.dim2-1), xy.col(xy.dim2-1), fn, isCont, k, cn, vc)
    } // apply

} // DecisionTreeC45_I object


//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `DecisionTreeC45_ITest` object is used to test the `DecisionTreeC45_I` class.
 ...
 */
object DecisionTreeC45_ITest extends App
{
    // training-set -----------------------------------------------------------
...
//  val flag = Array (false, true, true, false)
    ...
    val cl = new DecisionTreeC45_I (x, y, fn, flag, 2, null, vc)      // create the classifier            
    cl.train ()
    cl.printTree ()
