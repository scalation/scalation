 ...
 */
class TranRegression2 (x: MatriD, y: VectoD, transform: FunctionS2S = log,
...
} // TranRegression2 class


//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `TranRegression2Test` object tests `TranRegression2` class using the following
 *  regression equation.
 *  <p>
 *      log (y)  =  b dot x  =  b_0 + b_1*x_1 + b_2*x_2.
 *  <p>
 *  > runMain scalation.analytics.TranRegression2Test
 */
object TranRegression2Test extends App
{
    ...
    val trg   = new TranRegression2 (x, y)
    trg.train ()
    println ("fit = " + trg.fit)
