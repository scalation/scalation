...
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `ExampleAutoMPG_Correlation` object performs correlation analysis on
 *  the UCI AutoMPG dataset.
 *  @see archive.ics.uci.edu/ml/datasets/Auto+MPG
 *  > runMain scalation.analytics.ExampleAutoMPG_Correlation
 */
object ExampleAutoMPG_Correlation extends App
{
    banner ("Correlation Analysis: y vs. x.col(j")
    for (j <- x.range2) {
        val x_j = x.col (j)
        val correlation = y corr x_j
        val corr2       = correlation * correlation
        println (s"correlation of y vs. x.col($j) = $correlation \t $corr2 \t ${fname(j)}")
        new Plot (x_j, y, null, s"y vs, x.col($j)")
    } // for

} // ExampleAutoMPG_Correlation object


//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `ExampleAutoMPG_NullModel` object performs `NullModel` on the UCI AutoMPG
 *  dataset.
 *  @see archive.ics.uci.edu/ml/datasets/Auto+MPG
 *  > runMain scalation.analytics.ExampleAutoMPG_NullModel
 */
object ExampleAutoMPG_NullModel extends App
{
    banner ("NullModel model: y = b₀")
    val rg = NullModel (xy)
    NullModel.analyze (rg)                             // perform basic analysis

    val yp = rg.predict ()                             // predict y for all x rows
    val e  = y - yp                                    // error/residual vector
    println (s"error e = $e")

    new Plot (t, y, yp, "NullModel")
    new Plot (t, e, null, "NullModel error")

} // ExampleAutoMPG_NullModel object


//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `ExampleAutoMPG_SimplerRegression` object performs `SimplerRegression`
 *  on the UCI AutoMPG dataset.
 *  @see archive.ics.uci.edu/ml/datasets/Auto+MPG
 *  > runMain scalation.analytics.ExampleAutoMPG_SimplerRegression
 */
object ExampleAutoMPG_SimplerRegression extends App
{
    banner ("SimplerRegression model: y = b₁*x₁")
    val rg = SimplerRegression (xy)                    // create a SimplerRegression model
    analyze (rg)                                       // perform basic analysis

    val x  = xy.sliceCol (0, 1)                        // predictors values
    val yp = rg.predict (x)                            // predict y for all x rows
    val e  = y - yp                                    // error/residual vector
    println (s"error e = $e")

    new Plot (t, y, yp, "SimplerRegression")
    new Plot (t, e, null, "SimplerRegression error")

} // ExampleAutoMPG_SimplerRegression object


//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `ExampleAutoMPG_SimpleRegression` object performs `SimpleRegression`
 *  on the UCI AutoMPG dataset.
 *  @see archive.ics.uci.edu/ml/datasets/Auto+MPG
 *  > runMain scalation.analytics.ExampleAutoMPG_SimpleRegression
 */
object ExampleAutoMPG_SimpleRegression extends App
{
    banner ("SimpleRegression model: y = b₀ + b₁*x₁")
    val rg = SimpleRegression (oxy)                    // create a SimpleRegression model
    analyze (rg)                                       // perform basic analysis

    val x  = oxy.sliceCol (0, 2)                       // predictors values
    val yp = rg.predict (x)                            // predict y for all x rows
    val e  = y - yp                                    // error/residual vector
    println (s"error e = $e")

    new Plot (t, y, yp, "SimpleRegression")
    new Plot (t, e, null, "SimpleRegression error")

} // ExampleAutoMPG_SimpleRegression object

                                  
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `ExampleAutoMPG_Regression` object performs `Regression` on the UCI AutoMPG
 *  dataset.
 *  @see archive.ics.uci.edu/ml/datasets/Auto+MPG
 *  > runMain scalation.analytics.ExampleAutoMPG_Regression
 */
object ExampleAutoMPG_Regression extends App
{
    banner ("Regression model: y = b₀ + b₁*x₁ + b₂*x₂ + b₃*x₃ + b₄*x₄ + b₅*x₅ + b₆*x₆")
    val rg = Regression (oxy, fname)                   // create a Regression Model
    analyze (rg)                                       // perform basic analysis

    println ("Summary")
    println (rg.summary)                               // produce summary statistics

    val x  = oxy.sliceCol (0, oxy.dim2-1)              // predictors values
    val yp = rg.predict (x)                            // predict y for x rows
    val e  = y - yp                                    // error/residual vector
    println (s"error e = $e")

    new Plot (t, y, yp, "Regression")
    new Plot (t, e, null, "Regression error")

} // ExampleAutoMPG_Regression object
