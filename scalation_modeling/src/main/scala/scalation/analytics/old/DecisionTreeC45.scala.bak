 ...
 *  FIX: change code from ID3 to C4.5 implementation
 ...
 */
class DecisionTreeC45 (x: MatrixI, y: Array [Int], v: Array [Int], k: Int = 2)
...
object DecisionTreeC45Test extends App
{
    ...
    val cl = new DecisionTreeC45 (x, y, v)                // create the classifier            
    cl.train ()
