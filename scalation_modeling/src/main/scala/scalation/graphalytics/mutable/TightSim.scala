...
import scala.collection.mutable.{ArrayStack, ListBuffer, Map, HashMap, MutableList, Set => SET}
 ...
 */
class TightSim [TLabel: ClassTag] (g: Graph [TLabel], q: Graph [TLabel]) 
      extends GraphMatcher (g, q)
{
    ...
    private val phi0 = new DualSim (g, q).mappings ()
 ...
 *  > run-main scalation.graphalytics.mutable.TightSimTest
 */
 ...
 *  > run-main scalation.graphalytics.mutable.TightSimTest2
 */
 ...
 *  > run-main scalation.graphalytics.mutable.TightSimTest3
 */
