 ...
 *
 *  `MGraph` Strict Simulation CAR Using Mutable Sets
 */
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The 'MStrictSimCAR' class provides an implementation for strict simulation
 *  graph pattern matching.  This version uses `DualSim`.
 *  @see hipore.com/ijbd/2014/IJBD%20Vol%201%20No%201%202014.pdf
 *  @param q  the query graph Q(U, D, k)
 *  @param g  the data graph  G(V, E, l)
 */
class MStrictSimCAR [TLabel: ClassTag] (g: MGraph [TLabel], q: MGraph [TLabel]) 
      extends GraphMatcher (g, q)
{
    ...
    private val phi0 = new MDualSimCAR (g, q).mappings ()               // initial mapping results from Dual Simulation
 ...
 *  > run-main scalation.graphalytics.mutable.MStrictSimCARTest
 */
object MStrictSimCARTest extends App
{
    val g = EX_GRAPH.g1
    val q = EX_GRAPH.q1
    ...
    (new MStrictSimCAR (g, q)).test ("MStrictSimCAR")    // MStrict Simulation Pattern Matcher

} // MStrictSimCARTest object


//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `MStrictSimCARTest2` object is used to test the `MStrictSimCAR` class.
 *  > run-main scalation.graphalytics.mutable.MStrictSimCARTest2
 */
object MStrictSimCARTest2 extends App
{
    val g = EX_GRAPH.g2
    val q = EX_GRAPH.q2
...
} // MStrictSimCARTest2 object


//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `MStrictSimCARTest3` object tests the `MStrictSimCAR` class by passing data graph
 *  and query graph relative file paths.
 *  > run-main scalation.graphalytics.mutable.MStrictSimCARTest3
 */
object MStrictSimCARTest3 extends App
{
