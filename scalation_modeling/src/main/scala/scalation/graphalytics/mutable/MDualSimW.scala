 ...
 *  order to save space.  This version also supports wildcards and regex.
 ...
 *  run-main scalation.graphalytics.mutable.MDualSimWTest
 */
object MDualSimWTest extends App
{
    ...
    val matcher = new MDualSimW (g, q)                       // Graph Simulation Pattern Matcher
 ...
 *  run-main scalation.graphalytics.mutable.MDualSimWTest2
 */
...
//
//    val matcher = new MDualSimW (g, q)                   // Dual Graph Simulation Pattern Matcher
//    val phi     = time { matcher.mappings () }             // time the matcher
//    matcher.showMappings (phi)                             // display results
//
