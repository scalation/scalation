      ...
      extends GraphMatcher (g, q)
{
    ...
    private val phi0 = new MDualSim (g, q).mappings ()                  // initial mapping results from Dual Simulation
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `MStrictSimTest3` object tests the `MStrictSim` class by passing data graph
