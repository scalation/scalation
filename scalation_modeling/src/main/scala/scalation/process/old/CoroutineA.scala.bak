 ...
 */
abstract class CoroutineA extends Actor
{
     ...
     */
    def yyield (other: CoroutineA, quit: Boolean = false)
    {
        if (other != null) {
            if (other.started) {
 ...
 *    Cor2: phase 2
 */
object CoroutineATest extends App
{
    class Cor1 extends CoroutineA
    {
        def act ()
        {
