...
//  def filter (p: StrNum => Boolean): VectoS
     ...
     */
    def slice (rg: Range): VectoS = slice (rg.start, rg.end)

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Slice 'this' vector excluding the given range 'rg'.
     *  @param rg  the excluded range of the slice
     */
    def sliceEx (rg: Range): VectoS = slice (0, rg.start) ++ slice (rg.end, dim)
     ...
     */
    def selectEx (basis: Array [Int]): VectoS = select ((range diff basis).toArray)

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Select all elements of 'this' vector excluding ones in the 'basis'.
     *  @param basis  the index positions to be excluded
     */
    def selectEx (basis: VectoI): VectoS = select ((range diff basis()).toArray)
     ...
     */
    def reorder (rnk: VectoI): VectoS = VectorS (for (i <- range) yield this(rnk(i)))
