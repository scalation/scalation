...
//  def filter (p: Long => Boolean): VectoL
     ...
     */
    def slice (rg: Range): VectoL = slice (rg.start, rg.end)

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Slice 'this' vector excluding the given range 'rg'.
     *  @param rg  the excluded range of the slice
     */
    def sliceEx (rg: Range): VectoL = slice (0, rg.start) ++ slice (rg.end, dim)
     ...
     */
    def split (k: Int): Array [VectoL] = null
     ...
     */
    def selectEx (basis: Array [Int]): VectoL = select ((range diff basis).toArray)

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Select all elements of 'this' vector excluding ones in the 'basis'.
     *  @param basis  the index positions to be excluded
     */
    def selectEx (basis: VectoI): VectoL = select ((range diff basis()).toArray)
     ...
     */
    def reorder (rnk: VectoI): VectoL = VectorL (for (i <- range) yield this(rnk(i)))
