      ...
      extends MatriD with Error with Serializable
{
    ...
    def update (ir: Range, jr: Range, b: MatriD)
    {
        ...
        if (b.isInstanceOf [BidMatrixD]) {
            val bb = b.asInstanceOf [BidMatrixD]
            for (i <- ir) {
                _dg(i) = bb.dg(i - ir.start)
                if (i > ir.start) _sd(i-1) = bb.sd(i - ir.start - 1)
            } // for
        } else {
            flaw ("update", "must convert b to a BidMatrixD first")
        } // if
    } // update
    ...
    {
        throw new UnsupportedOperationException ("values for BidMatrixD should be diagonal")
    } // set
    ...
    def set (u: MatriD)
    {
        if (u.isInstanceOf [BidMatrixD]) {
            val uu = u.asInstanceOf [BidMatrixD]
            for (i <- range_d) _dg(i) = uu._dg(i)
            for (j <- range_s) _sd(j) = uu._sd(j)
        } else {
            flaw ("set", "must convert u to a BidMatrixD first")
        } // if
    } // set
    ...
    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Convert 'this' `BidMatrixD` into a `BidMatrixI`.
     */
     ...
     */
    def sliceCol (from: Int, end: Int): BidMatrixD =
    {
        val c = new BidMatrixD (end - from)
        for (j <- c.range2) {
            c._dg(j) = _dg(j + from)
    ...
    {
        throw new UnsupportedOperationException ("BidMatrixD must be square")
    } // slice
     ...
     */
    def sliceEx (row: Int, col: Int): BidMatrixD =
    {
        throw new UnsupportedOperationException ("BidMatrixD does not support sliceEx")
    } // sliceEx
    ...
    {
        throw new UnsupportedOperationException ("BidMatrixD does not support selectRows")
    } // selectRows
    ...
    {
        throw new UnsupportedOperationException ("BidMatrixD does not support selectCols")
    } // selectCols
    ...
    def t: BidMatrixD =
    {
        throw new UnsupportedOperationException ("BidMatrixD does not support transpose")
    } // t
    ...
    {
        throw new UnsupportedOperationException ("BidMatrixD does not support +:")
    } // +:
    ...
    def + (b: MatriD): BidMatrixD = 
    {
        val bid = b.asInstanceOf [BidMatrixD]
	if (d1 == bid.d1) {
            new BidMatrixD (_dg + bid.dg, _sd + bid.sd)
        } else {
    ...
    def + (u: VectoD): BidMatrixD =
    {
        throw new UnsupportedOperationException ("BidMatrixD does not support + with VectoD")
    } // +
    ...
    def * (b: MatriD): BidMatrixD = 
    {
        throw new UnsupportedOperationException ("BidMatrixD does not support * with general matrices")
    } // *

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Multiply 'this' bidiagonal matrix by matrix 'b'.  Requires 'b' to have
     *  type `BidMatrixD`, but returns a more general type of matrix.
     *  @param b  the matrix to multiply by
     */
     ...
     *  @param u  the vector to multiply by
     */
    def ** (u: VectoD): MatrixD = this * BidMatrixD (u)
     ...
     *  @param u  the vector to multiply by
     */
    def **: (u: VectoD): MatrixD = BidMatrixD (u) * this
     ...
     */
    def bsolve (y: VectoD): VectorD = solve (y)
    ...
    def inverse: MatriD =
    {
        ...
        for (i <- 0 until d1) b(i, i) = 1.0 / d(i)
 ...
 */
object BidMatrixD extends Error
{
    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
     ...
     */
    def apply (u: VectoD): BidMatrixD =
    {
        val x = new BidMatrixD (u.dim)
     ...
     */
    def apply (fileName: String): BidMatrixD =
    {
     ...
     */
    def eye (m: Int): BidMatrixD =
    {
        val c = new BidMatrixD (m)
 ...
 *  > runMain scalation.linalgebra.BidMatrixDTest
 */
object BidMatrixDTest extends App
{
    val a = new BidMatrixD (VectorD (3, 4, 5),
                            VectorD (2, 1))

    val b = new BidMatrixD (VectorD (2, 3, 4),
                            VectorD (5, 6))
