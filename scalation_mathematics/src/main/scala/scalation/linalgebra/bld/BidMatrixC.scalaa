      ...
      extends MatriC with Error with Serializable
{
    ...
    {
        throw new UnsupportedOperationException ("values for BidMatrixC should be diagonal")
    } // set
    ...
    def set (u: MatriC)
    {
        if (u.isInstanceOf [BidMatrixC]) {
            val uu = u.asInstanceOf [BidMatrixC]
            for (i <- range_d) _dg(i) = uu._dg(i)
            for (j <- range_s) _sd(j) = uu._sd(j)
        } else {
            flaw ("set", "must convert u to a BidMatrixC first")
        } // if
    } // set
    ...
    {
        throw new UnsupportedOperationException ("BidMatrixC must be square")
    } // slice
     ...
     */
    def sliceEx (row: Int, col: Int): BidMatrixC =
    {
        throw new UnsupportedOperationException ("BidMatrixC does not support sliceEx")
    } // sliceEx
    ...
    {
        throw new UnsupportedOperationException ("BidMatrixC does not support selectRows")
    } // selectRows
    ...
    {
        throw new UnsupportedOperationException ("BidMatrixC does not support selectCols")
    } // selectCols
    ...
    def t: BidMatrixC =
    {
        throw new UnsupportedOperationException ("BidMatrixC does not support transpose")
    } // t
    ...
    {
        throw new UnsupportedOperationException ("BidMatrixC does not support +:")
    } // +:
    ...
    def + (u: VectoC): BidMatrixC =
    {
        throw new UnsupportedOperationException ("BidMatrixC does not support + with VectoC")
    } // +
    ...
    def * (b: MatriC): BidMatrixC = 
    {
        throw new UnsupportedOperationException ("BidMatrixC does not support * with general matrices")
    } // *
     ...
     *  @param u  the vector to multiply by
     */
    def ** (u: VectoC): MatrixC = this * BidMatrixC (u)
     ...
     *  @param u  the vector to multiply by
     */
    def **: (u: VectoC): MatrixC = BidMatrixC (u) * this
     ...
     */
    def sumAbs: Complex = _dg.norm1 + _sd.norm1
...
object BidMatrixC extends Error
{
     ...
     */
    def apply (u: VectoC): BidMatrixC =
    {
        val x = new BidMatrixC (u.dim)
 ...
 *  > runMain scalation.linalgebra.BidMatrixCTest
 */
