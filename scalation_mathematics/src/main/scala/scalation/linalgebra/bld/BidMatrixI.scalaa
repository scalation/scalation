      ...
      extends MatriI with Error with Serializable
{
     ...
     */
    def zero (m: Int = dim1, n: Int = dim2): BidMatrixI = new BidMatrixI (m)
    ...
    def set (u: MatriI)
    {
        if (u.isInstanceOf [BidMatrixI]) {
            val uu = u.asInstanceOf [BidMatrixI]
            for (i <- range_d) _dg(i) = uu._dg(i)
            for (j <- range_s) _sd(j) = uu._sd(j)
        } else {
            flaw ("set", "must convert u to a BidMatrixI first")
        } // if
    } // set
    ...
    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Convert 'this' `BidMatrixI` into a `BidMatrixI`.
     */
     ...
     */
    def sliceEx (row: Int, col: Int): BidMatrixI =
    {
        throw new UnsupportedOperationException ("BidMatrixI does not support sliceEx")
    } // sliceEx
     ...
     *  @param u  the vector to multiply by
     */
    def ** (u: VectoI): MatrixI = this * BidMatrixI (u)
     ...
     *  @param u  the vector to multiply by
     */
    def **: (u: VectoI): MatrixI = BidMatrixI (u) * this
     ...
     */
    def bsolve (y: VectoI): VectorI = solve (y)
     ...
     */
    def sumAbs: Int = _dg.norm1 + _sd.norm1
     ...
     */
    def lowerT: MatrixI = { val c = new MatrixI (dim1, dim1); c.setDiag (_dg); c }
...
object BidMatrixI extends Error
{
     ...
     */
    def apply (u: Array [VectoI], columnwise: Boolean = true): BidMatrixI =
    {
     ...
     */
    def apply (u: VectoI): BidMatrixI =
    {
        val x = new BidMatrixI (u.dim)
 ...
 *  > runMain scalation.linalgebra.BidMatrixITest
 */
