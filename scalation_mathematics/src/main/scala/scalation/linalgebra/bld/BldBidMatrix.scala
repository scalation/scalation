 ...
 *  > runMain scalation.linalgebra.bld.BldBidMatrix
 */
...
"""; val code3 = raw"""
    ...
    {
        throw new UnsupportedOperationException ("values for Bid$MATRIX should be diagonal")
    } // set
    ...
    def set (u: $MATRI)
    {
        if (u.isInstanceOf [Bid$MATRIX]) {
            val uu = u.asInstanceOf [Bid$MATRIX]
            for (i <- range_d) _dg(i) = uu._dg(i)
            for (j <- range_s) _sd(j) = uu._sd(j)
        } else {
            flaw ("set", "must convert u to a Bid$MATRIX first")
        } // if
    } // set
...
"""; val code4 = raw"""
    ...
    {
        throw new UnsupportedOperationException ("Bid$MATRIX must be square")
    } // slice
     ...
     */
    def sliceEx (row: Int, col: Int): Bid$MATRIX =
    {
        throw new UnsupportedOperationException ("Bid$MATRIX does not support sliceEx")
    } // sliceEx
    ...
    {
        throw new UnsupportedOperationException ("Bid$MATRIX does not support selectRows")
    } // selectRows
    ...
    {
        throw new UnsupportedOperationException ("Bid$MATRIX does not support selectCols")
    } // selectCols
"""; val code5 = raw"""
    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    ...
    def t: Bid$MATRIX =
    {
        throw new UnsupportedOperationException ("Bid$MATRIX does not support transpose")
    } // t
    ...
    {
        throw new UnsupportedOperationException ("Bid$MATRIX does not support +:")
    } // +:
    ...
    def + (u: $VECTO): Bid$MATRIX =
    {
        throw new UnsupportedOperationException ("Bid$MATRIX does not support + with $VECTO")
    } // +
...
"""; val code6 = raw"""
    ...
    def * (b: $MATRI): Bid$MATRIX = 
    {
        throw new UnsupportedOperationException ("Bid$MATRIX does not support * with general matrices")
    } // *
"""; val code7 = raw"""
    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
"""; val code8 = raw"""
     ...
     *  @param u  the vector to multiply by
     */
    def ** (u: $VECTO): $MATRIX = this * Bid$MATRIX (u)
     ...
     *  @param u  the vector to multiply by
     */
    def **: (u: $VECTO): $MATRIX = Bid$MATRIX (u) * this
...
"""; val code10 = raw"""
     ...
     */
    def sumAbs: $BASE = _dg.norm1 + _sd.norm1
...
object Bid$MATRIX extends Error
{
     ...
     */
    def apply (u: $VECTO): Bid$MATRIX =
    {
        val x = new Bid$MATRIX (u.dim)
 ...
 *  > runMain scalation.linalgebra.Bid${MATRIX}Test
 */
