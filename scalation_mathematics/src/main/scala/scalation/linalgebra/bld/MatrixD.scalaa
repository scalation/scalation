      ...
      extends MatriD with Error with Serializable
{
     ...
     */
    override def apply (iv: VectoI): MatrixD =
    {
        val a = Array.ofDim [Array [Double]] (iv.dim)
    ...
    def set (b: MatriD)
    {
        if (b.isInstanceOf [MatrixD]) {
            ...
            flaw ("set", "must convert b to a MatrixD first")
        } // if
    } // set
    ...
    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Convert 'this' `MatrixD` into an integer matrix `MatrixI`.
     */
    def toInt: MatrixI =
    {
    ...
    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Convert 'this' `MatrixD` into a double matrix `MatrixD`.
     */
     ...
     */
    override def map (f: VectoD => VectoD): MatrixD =
    {
        MatrixD (for (i <- range1) yield f(new VectorD (v(i).length, v(i))), false)
    } // map
    ...
    {
        if (from >= end) return new MatrixD (0, dim2)
    ...
    {
        if (from >= end) return new MatrixD (dim1, 0)
...
//  } // t
     ...
     */
    override def ** (b: MatriD): MatrixD = MatrixD (for (i <- range1) yield this(i) * b(i), false)
...
object MatrixD extends Error
{
     ...
     */
    def apply (u: Array [Array [Double]]): MatrixD =
    {
        new MatrixD (u.length, u(0).length, u)
    } // apply
