...
//  def filter (p: Rational => Boolean): VectoQ
     ...
     */
    def slice (rg: Range): VectoQ = slice (rg.start, rg.end)

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Slice 'this' vector excluding the given range 'rg'.
     *  @param rg  the excluded range of the slice
     */
    def sliceEx (rg: Range): VectoQ = slice (0, rg.start) ++ slice (rg.end, dim)
     ...
     */
    def split (k: Int): Array [VectoQ] = null
     ...
     */
    def selectEx (basis: Array [Int]): VectoQ = select ((range diff basis).toArray)

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Select all elements of 'this' vector excluding ones in the 'basis'.
     *  @param basis  the index positions to be excluded
     */
    def selectEx (basis: VectoI): VectoQ = select ((range diff basis()).toArray)
     ...
     */
    def reorder (rnk: VectoI): VectoQ = VectorQ (for (i <- range) yield this(rnk(i)))
