...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `SparseMatrixD` class stores and operates on Matrices of `Double`s.  Rather
...
//  } // constructor
    ...
    def set (u: MatriD)
    {
        if (u.isInstanceOf [SparseMatrixD]) {
            val uu = u.asInstanceOf [SparseMatrixD]
            for (i <- range1; j <- range2) this(i, j) = uu(i, j)
        } else {
            flaw ("set", "must convert u to a SparseMatrixD first")
        } // if
    } // set
    ...
    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Convert 'this' `SparseMatrixD` into a `MatrixI`.
     */
    def toInt: MatrixI =
    {
     ...
     */
    def mdot (b: MatriD): SparseMatrixD =
    {
