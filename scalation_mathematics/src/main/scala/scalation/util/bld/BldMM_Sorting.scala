 ...
 *  various base types.
 *  > runMain scalation.util.bld.BldMM_Sorting
 */
object BldMM_Sorting extends App with BldParams
{
    ...
    for (k <- kind) {
        ...
        val IMPORT    = if (BASE == "StrNum") "import scalation.math.StrO"
                        else if (BASE == "TimeNum") "import scalation.math.TimeO"
                        else if (CUSTOM contains BASE) s"import scalation.math.$BASE"
                        else ""
        val IMPORT2   = if (BASE == "StrNum") s"import scalation.math.StrO.{StrNum, $ZERO}"
                        else if (BASE == "TimeNum") s"import scalation.math.TimeO.{TimeNum, $ZERO}"
                        else if (CUSTOM contains BASE) s"import scalation.math.$BASE.$ZERO"
                        else ""
 ...
 *  slower, but do not modify the array.  This class is specialized for `${BASE}`.
...
class $SORTING (a: $MM_ARRAY)
{
     ...
     */
    def median (p: Int, r: Int, k: Int): $BASE =
    {
        if (p == r) return a(p)
     ...
     */
    def median (k: Int = (n+1)/2): $BASE = median (0, n-1, k)
"""; val code2 = raw"""
    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
"""; val code3 = raw"""
     ...
     *  @param k   the type of median (k-th smallest element)
     */
    def imedian (rk: Array [Int], p: Int, r: Int, k: Int): $BASE =
    {
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `${SORTING}Test` object is used to test the correctness and performance
 *  of the 'median' and 'imedian' methods in the `$SORTING` class.
 */
object ${SORTING}Test extends App
{
    var md = $ZERO
    val rn = new Random ()
    val n  = 1000000
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `${SORTING}Test2` object is used to test the correctness and performance
 *  of the 'qsort' and 'iqsort' sorting methods in the `$SORTING` class.
 */
object ${SORTING}Test2 extends App
{
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `${SORTING}Test3` object is used to test the correctness and performance
 *  of the 'selsort' and 'iselsort' sorting methods in the `$SORTING` class.
 */
object ${SORTING}Test3 extends App
{
    import scala.util.Sorting.quickSort
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `${SORTING}Test4` object is used to test the correctness and performance
 *  of the 'qsort2' and 'iqsort2' sorting methods in the `$SORTING` class.
 *  The sort is in decreasing order.
 */
object ${SORTING}Test4 extends App
{
    import scala.util.Sorting.quickSort
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `${SORTING}Test5` object is used to test the correctness and performance
 *  of the 'selsort2' and 'iselsort2' sorting methods in the `$SORTING` class.
 *  The sort is in decreasing order.
 */
object ${SORTING}Test5 extends App
{
    import scala.util.Sorting.quickSort
...
} // ${SORTING}Test5 object

"""

// Ending of string holding code template --------------------------------------

//      println (code); prinln (code2); println (code3); println (code4)
//      println (code4); prinln (code5); println (code6)

        val writer = new PrintWriter (new File (DIR + _l + SORTING + ".scalaa"))
        writer.write (code)
        writer.write (code2)
        writer.write (code3)
        writer.write (code4)
