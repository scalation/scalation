...
import scalation.math.TimeO._0
 ...
 *  slower, but do not modify the array.  This class is specialized for `TimeNum`.
 *  @see `Sorting` for a generic version of this class.
 *  @param a  the array to operate on
 */
class MM_SortingT (a: MM_ArrayT)
{
     ...
     */
    def median (p: Int, r: Int, k: Int): TimeNum =
    {
        if (p == r) return a(p)
     ...
     */
    def median (k: Int = (n+1)/2): TimeNum = median (0, n-1, k)
     ...
     *  @param k   the type of median (k-th smallest element)
     */
    def imedian (rk: Array [Int], p: Int, r: Int, k: Int): TimeNum =
    {
     ...
     *  @param k  the type of median (e.g., k = (n+1)/2 is the median)
     */
    def imedian (k: Int = (n+1)/2): TimeNum =
    {
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `MM_SortingT` companion object provides shortcuts for calling methods from
 *  the `MM_SortingT` class.
 */
object MM_SortingT
{
    // Direct median and sorting --------------------------------------------
     ...
     */
    def median (a: MM_ArrayT, k: Int): TimeNum = (new MM_SortingT (a)).median (k)

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Fast, ascending, unstable sort.
     *  @param a  the array to be sorted
     */
    def qsort (a: MM_ArrayT) { (new MM_SortingT (a)).qsort () }

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Slow, ascending, stable sort.
     *  @param a  the array to be sorted
     */
    def selsort (a: MM_ArrayT) { (new MM_SortingT (a)).selsort () }

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Fast, descending, unstable sort.
     *  @param a  the array to be sorted
     */
    def qsort2 (a: MM_ArrayT) { (new MM_SortingT (a)).qsort2 () }

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Slow, descending, stable sort.
     *  @param a  the array to be sorted
     */
    def selsort2 (a: MM_ArrayT) { (new MM_SortingT (a)).selsort2 () }
     ...
     *  @param a  the array to be examined
     */
    def imedian (a: MM_ArrayT, k: Int): TimeNum = (new MM_SortingT (a)).imedian (k)

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Fast, ascending, unstable indirect sort.
     *  @param a  the array to be sorted
     */
    def iqsort (a: MM_ArrayT): Array [Int] = (new MM_SortingT (a)).iqsort ()

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Slow, ascending, stable indirect sort.
     *  @param a  the array to be sorted
     */
    def iselsort (a: MM_ArrayT): Array [Int] = (new MM_SortingT (a)).iselsort ()

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Fast, descending, unstable indirect sort.
     *  @param a  the array to be sorted
     */
//  def iqsort2 (a: MM_ArrayT) { (new MM_SortingT (a)).iqsort2 () }   // FIX: implement

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Slow, descending, stable indirect sort.
     *  @param a  the array to be sorted
     */
    def iselsort2 (a: MM_ArrayT): Array [Int] = (new MM_SortingT (a)).iselsort2 ()

} // MM_SortingT


//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `MM_SortingTTest` object is used to test the correctness and performance
 *  of the 'median' and 'imedian' methods in the `MM_SortingT` class.
 */
object MM_SortingTTest extends App
{
    var md = _0
    val rn = new Random ()
    val n  = 1000000
    val a  = MM_ArrayT (9, 1, 8, 2, 7, 3, 6, 4, 5)
    val aa = MM_ArrayT.ofDim (n)
    ...
    for (k <- 1 to 5) {
        val med = new MM_SortingT (MM_ArrayT (9, 1, 8, 2, 7, 3, 6, 4, 5))
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `MM_SortingTTest2` object is used to test the correctness and performance
 *  of the 'qsort' and 'iqsort' sorting methods in the `MM_SortingT` class.
 */
object MM_SortingTTest2 extends App
{
    ...
    println ("--------------------------------------------------------------")
    val a1 = MM_ArrayT (9, 1, 8, 2, 7, 3, 6, 4, 5)
    println ("Test direct: a1 = " + a1.deep)
    val srt = new MM_SortingT (a1)
    srt.qsort ()
    ...
    println ("--------------------------------------------------------------")
    val a2 = MM_ArrayT (9, 1, 8, 2, 7, 3, 6, 4, 5)
    println ("Test indirect: a2 = " + a2.deep)
    val isrt = new MM_SortingT (a2)
    rk = isrt.iqsort ()
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `MM_SortingTTest3` object is used to test the correctness and performance
 *  of the 'selsort' and 'iselsort' sorting methods in the `MM_SortingT` class.
 */
object MM_SortingTTest3 extends App
{
    import scala.util.Sorting.quickSort
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `MM_SortingTTest4` object is used to test the correctness and performance
 *  of the 'qsort2' and 'iqsort2' sorting methods in the `MM_SortingT` class.
 *  The sort is in decreasing order.
 */
object MM_SortingTTest4 extends App
{
    import scala.util.Sorting.quickSort
...
} // MM_SortingTTest4Test

//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `MM_SortingTTest5` object is used to test the correctness and performance
 *  of the 'selsort2' and 'iselsort2' sorting methods in the `MM_SortingT` class.
 *  The sort is in decreasing order.
 */
object MM_SortingTTest5 extends App
{
    import scala.util.Sorting.quickSort
