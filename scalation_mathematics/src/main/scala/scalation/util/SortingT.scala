 ...
 */
class SortingT (a: Array [TimeNum])
{
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `SortingT` companion object provides shortcuts for calling methods from
 *  the `SortingT` class.
 */
object SortingT
{
     ...
     */
    def median (a: Array [TimeNum], k: Int): TimeNum = (new SortingT (a)).median (k)

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Fast, ascending, unstable sort.
     *  @param a  the array to be sorted
     */
    def qsort (a: Array [TimeNum]) { (new SortingT (a)).qsort () }

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Slow, ascending, stable sort.
     *  @param a  the array to be sorted
     */
    def selsort (a: Array [TimeNum]) { (new SortingT (a)).selsort () }

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Fast, descending, unstable sort.
     *  @param a  the array to be sorted
     */
    def qsort2 (a: Array [TimeNum]) { (new SortingT (a)).qsort2 () }

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Slow, descending, stable sort.
     *  @param a  the array to be sorted
     */
    def selsort2 (a: Array [TimeNum]) { (new SortingT (a)).selsort2 () }
     ...
     *  @param a  the array to be examined
     */
    def imedian (a: Array [TimeNum], k: Int): TimeNum = (new SortingT (a)).imedian (k)

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Fast, ascending, unstable indirect sort.
     *  @param a  the array to be sorted
     */
    def iqsort (a: Array [TimeNum]): Array [Int] = (new SortingT (a)).iqsort ()

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Slow, ascending, stable indirect sort.
     *  @param a  the array to be sorted
     */
    def iselsort (a: Array [TimeNum]): Array [Int] = (new SortingT (a)).iselsort ()

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Fast, descending, unstable indirect sort.
     *  @param a  the array to be sorted
     */
//  def iqsort2 (a: Array [TimeNum]) { (new SortingT (a)).iqsort2 () }   // FIX: implement

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Slow, descending, stable indirect sort.
     *  @param a  the array to be sorted
     */
    def iselsort2 (a: Array [TimeNum]): Array [Int] = (new SortingT (a)).iselsort2 ()

} // SortingT


//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `SortingTTest` object is used to test the correctness and performance
 *  of the 'median' and 'imedian' methods in the `SortingT` class.
 */
object SortingTTest extends App
{
    var md = _0
    val rn = new Random ()
    val n  = 1000000
    val a  = Array [TimeNum] (9, 1, 8, 2, 7, 3, 6, 4, 5)
    val aa = Array.ofDim [TimeNum] (n)
    ...
    for (k <- 1 to 5) {
        val med = new SortingT (Array [TimeNum] (9, 1, 8, 2, 7, 3, 6, 4, 5))
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `SortingTTest2` object is used to test the correctness and performance
 *  of the 'qsort' and 'iqsort' sorting methods in the `SortingT` class.
 */
object SortingTTest2 extends App
{
    ...
    println ("--------------------------------------------------------------")
    val a1 = Array [TimeNum] (9, 1, 8, 2, 7, 3, 6, 4, 5)
    println ("Test direct: a1 = " + a1.deep)
    val srt = new SortingT (a1)
    srt.qsort ()
    ...
    println ("--------------------------------------------------------------")
    val a2 = Array [TimeNum] (9, 1, 8, 2, 7, 3, 6, 4, 5)
    println ("Test indirect: a2 = " + a2.deep)
    val isrt = new SortingT (a2)
    rk = isrt.iqsort ()
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `SortingTTest3` object is used to test the correctness and performance
 *  of the 'selsort' and 'iselsort' sorting methods in the `SortingT` class.
 */
object SortingTTest3 extends App
{
    import scala.util.Sorting.quickSort
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `SortingTTest4` object is used to test the correctness and performance
 *  of the 'qsort2' and 'iqsort2' sorting methods in the `SortingT` class.
 *  The sort is in decreasing order.
 */
object SortingTTest4 extends App
{
    import scala.util.Sorting.quickSort
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `SortingTTest5` object is used to test the correctness and performance
 *  of the 'selsort2' and 'iselsort2' sorting methods in the `SortingT` class.
 *  The sort is in decreasing order.
 */
object SortingTTest5 extends App
{
    import scala.util.Sorting.quickSort
