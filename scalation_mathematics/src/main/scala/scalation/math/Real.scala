     ...
     extends Fractional [Real] with Ordered [Real]
{
     ...
     */
    def ~^ (y: Real): Real = exp (y * Real.log (this))
    ...
    def ≈ (y: Real): Boolean  = (hi == y.hi && lo =~ y.lo)
   ...
   //:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
     ...
     */
    def in (lim: (Real, Real)): Boolean = lim._1 <= this && this <= lim._2
    def ∈ (lim: (Real, Real)): Boolean  = lim._1 <= this && this <= lim._2

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Determine whether 'this' is in the given set.
     *  @param lim  the given set of values
     */
    def in (set: Set [Real]): Boolean = set contains this
    def ∈ (set: Set [Real]): Boolean  = set contains this

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Determine whether 'this' is not within the given bounds
     *  @param lim  the given (lower, upper) bounds
     */
    def not_in (lim: (Real, Real)): Boolean = ! (lim._1 <= this && this <= lim._2)
    def ∉ (lim: (Real, Real)): Boolean      = ! (lim._1 <= this && this <= lim._2)
     ...
     *  @param lim  the given set of values
     */
    def not_in (set: Set [Real]): Boolean = ! (set contains this)
    def ∉ (set: Set [Real]): Boolean      = ! (set contains this)
     ...
     *  its magnitude.
     */
    private def extractSigDigits: (String, Int) =
    {
        var y     = abs
...
object Real
{
    ...
    //:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Create a real number from a pair of Doubles.
     *  @param xt  the tuple form of a real number
     */
    def apply (xt: (Double, Double)): Real = Real (xt._1, xt._2)
