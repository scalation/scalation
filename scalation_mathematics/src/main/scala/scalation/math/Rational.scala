     ...
     extends Fractional [Rational] with Ordered [Rational]
{
    ...
    def ≈ (q: Rational): Boolean  = near_eq (this, q)
     ...
     */
    def in (lim: (Rational, Rational)): Boolean = lim._1 <= this && this <= lim._2
    def ∈ (lim: (Rational, Rational)): Boolean  = lim._1 <= this && this <= lim._2

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Determine whether 'this' is in the given set.
     *  @param lim  the given set of values
     */
    def in (set: Set [Rational]): Boolean = set contains this
    def ∈ (set: Set [Rational]): Boolean  = set contains this

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Determine whether 'this' is not within the given bounds
     *  @param lim  the given (lower, upper) bounds
     */
    def not_in (lim: (Rational, Rational)): Boolean = ! (lim._1 <= this && this <= lim._2)
    def ∉ (lim: (Rational, Rational)): Boolean      = ! (lim._1 <= this && this <= lim._2)
     ...
     *  @param lim  the given set of values
     */
    def not_in (set: Set [Rational]): Boolean = ! (set contains this)
    def ∉ (set: Set [Rational]): Boolean      = ! (set contains this)
...
//  val maxDen = 18014398509481984l
     ...
     */
    def apply (qt: (Long, Long)): Rational = Rational (qt._1, qt._2)
