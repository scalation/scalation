      ...
      extends MatriC with Error with Serializable
{
    ...
    {
        throw new NoSuchMethodException ("SymTriMatrixC does not support selectCols")
    } // selectCols
    ...
    {
        throw new NoSuchMethodException ("SymTriMatrixC does not support + for VectoC")
    } // +
    ...
    def solve (l: MatriC, u: MatriC, b: VectoC): VectorC = 
    {
        ...
        val ll = l.asInstanceOf [MatrixC]
        val uu = u.asInstanceOf [MatrixC]
        ll.solve (uu, b)
    } // solve
     ...
     */
    def sumAbs: Complex = _dg.sumAbs + _sd.sumAbs + _sd.sumAbs
