      ...
      extends Error
{
    ...
    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Compute the L1 norm of 'this' matrix, i.e., maximum absolute column sum.
     */
     ...
     */
    def norm1est (inv: Boolean = true): Double =
    {
        val a  = this
        val at = a.t
        ...
        while (! done) {
            val j = x.abs.argmax ()
            e     = new VectorD ((j, 1.0), a.dim2)          // one in jth position
    ...
    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Compute the Frobenius norm of 'this' matrix, i.e., square root of the
     *  elements squared
     */
    def normF: Double = (for (i <- range1) yield this(i).normSq).sum
