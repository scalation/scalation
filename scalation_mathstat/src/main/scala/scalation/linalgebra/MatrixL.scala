...
//  } // t
    ...
    def lud_npp: (MatrixL, MatrixL) =
    {
        ...
        for (i <- u.range1) {
            val pivot = u.v(i)(i)
            if (pivot =~ 0l) flaw ("lud_npp", "use lud since you have a zero pivot")
            l.v(i)(i) = 1l
    ...
    def solve (l: MatriL, u: MatriL, b: VectoL): VectorL =
    {
        ...
        u.bsolve (y).asInstanceOf [VectorL]
    } // solve
     ...
     *  @param b   the constant vector
     */
    def solve (lu: (MatriL, MatriL), b: VectoL): VectorL = solve (lu._1, lu._2, b)
     ...
     *  @param b  the constant vector
     */
    def solve (u: MatriL, b: VectoL): VectorL = solve (this, u, b)
 ...
 */
object MatrixLTest extends App with PackageInfo
{
    for (l <- 1 to 4) {
