      ...
      extends MatriL with Error with Serializable
{
    ...
    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Convert 'this' `MatrixL` into a `MatrixI`.
     */
    def toInt: MatrixI =
    {
    ...
    {
        if (from >= end) return new MatrixL (0, 0)
     ...
     *  @param rowIndex  the row index positions (e.g., (0, 2, 5))
     */
    def selectRows2 (rowIndex: Array [Int]): MatrixL =
    {
        val a = Array.ofDim [Array [Long]] (rowIndex.length)
 ...
 *  > run-main scalation.linalgebra.MatrixLTest
 */
