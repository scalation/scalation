      ...
      extends MatriQ with Error with Serializable
{
    ...
    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Convert 'this' `MatrixQ` into a `MatrixI`.
     */
    def toInt: MatrixI =
    {
    ...
    {
        if (from >= end) return new MatrixQ (0, 0)
     ...
     *  @param rowIndex  the row index positions (e.g., (0, 2, 5))
     */
    def selectRows2 (rowIndex: Array [Int]): MatrixQ =
    {
        val a = Array.ofDim [Array [Rational]] (rowIndex.length)
