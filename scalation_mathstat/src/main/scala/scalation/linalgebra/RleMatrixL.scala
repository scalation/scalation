...
{ 
    ...
    def ** (u: VectoL): MatriL = 
    {
        var c = new RleMatrixL (dim1,dim2)
     ...
     */
    def lud: Tuple2 [RleMatrixL, RleMatrixL] = 
    {
        val l = new RleMatrixL (dim1, dim2)
        val u = new RleMatrixL (dim1, dim2)
    ...
    def lud_ip: (RleMatrixL, RleMatrixL) = 
    {
        ...
        var l = new RleMatrixL (dim1, dim2)
     ...
     */
    def solve (l: MatriL,u: MatriL, b: VectoL): RleVectorL = 
    {
        ...
        u.bsolve (y).asInstanceOf [RleVectorL]
    } // solve
     ...
     *  @param b   the constant vector
     */
    def solve (lu: Tuple2 [MatriL, MatriL], b: VectoL): RleVectorL = solve (lu._1, lu._2, b)
     ...
     *  @param b  the constant vector
     */
    def solve (u: MatriL, b: VectoL): RleVectorL = solve (this, u, b)

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Solve for 'x' in the equation 'a*x = b' where 'a' is 'this' matrix.
     *  @param b  the constant vector.
     */ 
    def solve (b: VectoL): RleVectorL = solve (lud, b)
 ...
 *  > run-main scalation.linalgebra.RleMatrixLTest
 */
object RleMatrixLTest extends App with PackageInfo
{
    for (l <- 1 to 4) {
