...
{ 
     ...
     */
    def lud: Tuple2 [RleMatrixQ, RleMatrixQ] = 
    {
        val l = new RleMatrixQ (dim1, dim2)
        val u = new RleMatrixQ (dim1, dim2)
    ...
    def lud_ip: (RleMatrixQ, RleMatrixQ) = 
    {
        ...
        var l = new RleMatrixQ (dim1, dim2)
     ...
     */
    def solve (l: MatriQ,u: MatriQ, b: VectoQ): RleVectorQ = 
    {
        ...
        u.bsolve (y).asInstanceOf [RleVectorQ]
    } // solve
     ...
     *  @param b   the constant vector
     */
    def solve (lu: Tuple2 [MatriQ, MatriQ], b: VectoQ): RleVectorQ = solve (lu._1, lu._2, b)
     ...
     *  @param b  the constant vector
     */
    def solve (u: MatriQ, b: VectoQ): RleVectorQ = solve (this, u, b)

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Solve for 'x' in the equation 'a*x = b' where 'a' is 'this' matrix.
     *  @param b  the constant vector.
     */ 
    def solve (b: VectoQ): RleVectorQ = solve (lud, b)
 ...
 */
object RleMatrixQTest extends App with PackageInfo
{
    for (l <- 1 to 4) {
