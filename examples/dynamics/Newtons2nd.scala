 ...
 * @compile scalac -cp ../../classes -d classes Newtons2nd.scala
 * @run     scala -cp ../../classes:classes dynamics.Newtons2nd
 */
...
/*:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::*/
/** This object is used to test the RungeKutta (RK) and DormandPrince (DP) ODE
 *  solvers by applying them to Newton's Second Law of Motion, f = ma = -gm.
 *  The flight of a golf ball is simulated from impact until the ball hits the
 *  ground.  Note, a more realistic simulation would take additional forces
 *  into account: drag, lift and spin.
 */
object Newtons2nd extends App
{
    ...
    val p0 = new VectorD (0.0, 0.0)                  // initial position (x, y) at time t0 = 0
