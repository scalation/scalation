 ...
 *
 *  `MGraph` Tight Simulation CAR Using Mutable Sets
 */
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The 'MTightSimCAR' class provides an implementation for tight simulation
 *  graph pattern matching.  This version uses `DualSim`.
 *  @see hipore.com/ijbd/2014/IJBD%20Vol%201%20No%201%202014.pdf
 *  @param q  the query graph Q(U, D, k)
 *  @param g  the data graph  G(V, E, l)
 */
class MTightSimCAR [TLabel: ClassTag] (g: MGraph [TLabel], q: MGraph [TLabel]) 
      extends GraphMatcher (g, q)
{
     ...
     */
    def mappings2 (): HashMap [Int, Array [SET [Int]]] = tightSim (new MDualSimCAR (g, q).mappings ())
 ...
 *  > run-main scalation.graphalytics.mutable.MTightSimCARTest
 */
object MTightSimCARTest extends App
{
    val g = EX_GRAPH.g1
    val q = EX_GRAPH.q1
    ...
    (new MTightSimCAR (g, q)).test ("MTightSimCAR")    // MTight Simulation Pattern Matcher

} // MTightSimCARTest object

//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `MTightSimCARTest2` object is used to test the `MTightSimCAR` class.
 *  > run-main scalation.graphalytics.mutable.MTightSimCARTest2
 */
object MTightSimCARTest2 extends App
{
    val g = EX_GRAPH.g2
    val q = EX_GRAPH.q2
...
} // MTightSimCARTest2 object

//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `MTightSimCARTest3` object is used to test the `MTightSimCAR` class.
 *  > run-main scalation.graphalytics.mutable.MTightSimCARTest3
 *
object MTightSimCARTest3 extends App
{
    val g = EX_GRAPH.g3
    val q = EX_GRAPH.q3
