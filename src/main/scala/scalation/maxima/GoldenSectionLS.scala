...
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `GoldenSectionLS` class performs a line search on f(x) to find a maximal
 ...
 *  scalar functions (see `GoldenSectionLSTest`).  If starting with a vector function
 *  'f(x)', simply define a new function 'g(y) = x0 + direction * y' (see `GoldenSectionLSTest2`).
 *  @param f  the scalar objective function to maximize
 */
class GoldenSectionLS (f: FunctionS2S)
{
    ...
    //:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Perform a Line Search (LS) using the Golden Search Algorithm.  Two
    ...
    def search (xmax: Double = 2.0, x1: Double = 0.0): Double =
    {
        ...
        breakable { for (k <- 1 to MAX_ITER) {   // expand right to try to find a down-up pattern
            ...
            if (DEBUG) println ("search: x1 = " + x1 + ", f1 = " + f1 +
                                      ", x2 = " + x2 + ", f2 = " + f2 +
                                      ", x3 = " + x3 + ", f3 = " + f3)
            if (f1 < f2 && f2 > f3) { matched = true; break }     // found up-down pattern, e.g., 10, 30, 20
            x2 = x3
...
object GoldenSectionLSTest2 extends App
{
    ...
    println ("\nProblem 4: 10 - x_0/4 + 5x_0^2 + x_0^4 - 9x_0^2 x_1 + 3x_1^2 - 2x_1^4")
