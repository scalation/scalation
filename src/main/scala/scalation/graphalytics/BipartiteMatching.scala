...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `BipartiteMatching` class provides an implementation of finding maximal
 *  Bipartite Matching.
 *  @see http://www.geeksforgeeks.org/maximum-bipartite-matching/
 *  @param  bpGraph  the bipartitte graph
 */
class BipartiteMatching (bpGraph: Array [Array [Boolean]]) 
{
...
object BipartiteMatchingTest extends App
{
    ...
    val bpMatch = new BipartiteMatching (bpGraph)
