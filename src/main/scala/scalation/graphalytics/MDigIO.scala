...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `MDigIO` class is used to write multi-digraphs to a file.
 *  @param g  the multi-digraph to write
 */
class MDigIO (g: MDigraph)
{
     ...
     *  <p>
     *      MDigraph (<name>, <inverse>, <nVertices>
    ...
    def write (name: String = g.name, base: String = BASE, ext: String = EXT)
    {
        ...
        pw.println (s"MDigraph (${g.name}, ${g.inverse}, ${g.size}")
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `MDigIO` object is the companion object to the `MDigIO` class and
...
object MDigIO
{
     ...
     */
    def apply (name: String, base: String = BASE, ext: String = EXT, sep: Char = ','): MDigraph =
    {
        val gFile  = base + name + ext                             // relative path-name for file
        ...
        new MDigraph (ch, label, elabel, l0(1) == "true", l0(0))
    } // apply
     ...
     */
    def read2Files (lFile: String, eFile: String, inverse: Boolean = false): MDigraph =
    {
     ...
     *  @param inverse   whether to store inverse adjacency sets (parents)
     */
    def read2PajekFile (lFile: String, eFile: String, inverse: Boolean = false): MDigraph =
    {
        val lLines = fromFile (lFile).getLines               // get the lines from lFile
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `MDigIOTest` object is used to test the `MDigIO` class and object.
 *  > run-main scalation.graphalytics.MDigIOTest
 */
object MDigIOTest extends App
{
    ...
    val ran_graph = MDigGen.genRandomGraph (size, nLabels, eLabels, avDegree, inverse, "ran_graph")
