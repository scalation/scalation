...
import collection.mutable.{ArrayBuffer, Queue, Set => SET}

import scalation.util.time

//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `DigMetrics` class provides methods for determining graph metrics that
 ...
 */
class DigMetrics (val g: Digraph, isUndirected: Boolean = true)
{
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `DigMetricstest` object is used to test the `DigMetrics` class.
 *  @see http://math.stackexchange.com/questions/240556/radius-diameter-and-center-of-graph
 */
object DigMetricsTest extends App
{
/***
    val g = new Digraph (Array (SET (4, 5),                // 0           // ch
                                ...
                                SET (8)))                  // 12   
***/
    val g = new Digraph (Array (SET (2, 1),                // 0           // ch
                                SET (3),                   // 1
                                SET (),                    // 2
                                SET ()),                   // 3
                         Array (1, 0, 0, 0))                
