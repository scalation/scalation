 ...
 */
class MTightSim (g: MGraph, q: MGraph) 
      extends GraphMatcher (g, q)
{
     ...
     */ 
    def filterGraph (phi: Array [SET [Int]]): MGraph = 
    {
     ...
     */
    def calculateTotalEdges (g: MGraph, balls: HashMap [Int, Ball], matchCenters: SET [Int]): Int = 
    {
 ...
 *  > run-main scalation.graphalytics.mutable.MTightSimTest
 */
 ...
 *  > run-main scalation.graphalytics.mutable.MTightSimTest2
 */
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `MTightSimTest3` object test the `MTightSim` class by passing data graph
 *  and query graph relative file paths.
 *  > run-main scalation.graphalytics.mutable.MTightSimTest3
 */
object MTightSimTest3 extends App 
{
    val g = MGraphIO ("gfile")
