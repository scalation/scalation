 ...
 *  companion object is used to form a matrix from an `MDigraph`.
 *----------------------------------------------------------------------------
...
object SSShortestPath
{
     ...
     */
    def apply (g: MDigraph, s: Int, hasNodeWeight: Boolean = false): SSShortestPath =
    {
        val n = g.size
 ...
 *  > run-main scalation.graphalytics.SSShortestPathTest
 */
 ...
 *  Input is in the form of graphs (`MDigraph`).
 *  @see http://thescipub.com/PDF/jcssp.2013.377.382.pdf (Fig. 1)
 *  > run-main scalation.graphalytics.SSShortestPathTest2
 */
object SSShortestPathTest2 extends App
{
    val g = new MDigraph (Array (SET (1, 2),                       // ch(0)
                                 SET (0, 3),                       // ch(1)
                                 SET (0, 1, 3),                    // ch(2)
                                 SET (1, 2)),                      // ch(3)
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `SSShortestPathTest2` object is used to test the `SSShortestPath` class.
 *  Input is in the form of graphs (`MDigraph`).  This test case requires
 *  'Tlabel' in `LabelType` to be VectorD.  Should be commented out otherwise.
 *  @see http://thescipub.com/PDF/jcssp.2013.377.382.pdf (Fig. 1)
 *  > run-main scalation.graphalytics.SSShortestPathTest3
 *
