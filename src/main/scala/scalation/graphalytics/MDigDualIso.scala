...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `MDigDualIso` class provides an implementation for Subgraph Isomorphism
 *  that uses Dual Graph Simulation for pruning.
 *  @param g  the data graph  G(V, E, l)
 *  @param q  the query graph Q(U, D, k)
 */
class MDigDualIso (g: MDigraph, q: MDigraph)
      extends DigMatcher (g, q)
{
    private val duals        = new MDigDualSim (g, q)      // object for Dual Simulation algorithm
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `MDigDualIsoTest` object is used to test the `MDigDualIso` class.
 *  > run-main scalation.graphalytics.DualIsoTest
 */
object MDigDualIsoTest extends App
{
    val g = MDigraph.g1
    val q = MDigraph.q1
    ...
    val matcher = new MDigDualIso (g, q)                  // Dual Subgraph Isomorphism Pattern Matcher
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `MDigDualIsoTest2` object is used to test the `MDigDualIso` class.
 *  > run-main scalation.graphalytics.DualIsoTest2
 */
object MDigDualIsoTest2 extends App
{
    val g = MDigraph.g2
    val q = MDigraph.q2
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `MDigDualIsoTest3` object is used to test the `MDigDualIso` class.
 */
object MDigDualIsoTest3 extends App
{
    ...
    val g = MDigGen.genRandomGraph (gSize, nLabels, eLabels, gAvDegree, false, "g")
    val q = MDigGen.genBFSQuery (qSize, qAvDegree, g, false, "q")
