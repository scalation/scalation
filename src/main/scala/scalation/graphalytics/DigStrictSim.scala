      ...
      extends DigMatcher (g, q)
{
    ...
    private val phi0 = new DigDualSim (g, q).mappings ()
     ...
     */ 
    def filterGraph (phi: Array [SET [Int]]): Digraph = 
    {
        ...
        new Digraph (newCh, g.label, g.inverse, g.name + "2")     // create a new data graph
    } // filterGraph
     ...
     */
    def calculateTotalEdges (g: Digraph, balls: HashMap [Int, DigBall], matchCenters: SET [Int]): Int = 
    {
...
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: ::::::::::::
/** The `DigStrictSimTest` object is used to test the `DigStrictSim` class.
 *  > run-main scalation.graphalytics.DigStrictSimTest
 */
object DigStrictSimTest extends App 
{
    val g = Digraph.g1p
    val q = Digraph.q1p
    ...
    (new DigStrictSim (g, q)).test ("DigStrictSim")   // Strict Graph Simulation Pattern Matcher

} // DigStrictSimTest object


//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: ::::::::::::
/** The `DigStrictSimTest2` object is used to test the `DigStrictSim` class.
 *  > run-main scalation.graphalytics.DigStrictSimTest2
 */
object DigStrictSimTest2 extends App 
{
    val g = Digraph.g2p
    val q = Digraph.q2p
...
} // DigStrictSimTest2 object


//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `DigStrictSimTest3` object test the `DigStrictSim` class by passing data graph
 *  and query graph relative file paths.
 *  > run-main scalation.graphalytics.DigStrictSimTest3
 */
object DigStrictSimTest3 extends App 
{
    val g = DigIO ("gfile")
    val q = DigIO ("qfile")
