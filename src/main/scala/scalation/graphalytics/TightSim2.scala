...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The 'TightSim2' class provides an implementation for tight simulation
 *  graph pattern matching.  This version uses `DualSim2`.
 *  @see hipore.com/ijbd/2014/IJBD%20Vol%201%20No%201%202014.pdf
 *  FIX: try to implement without using parent references 'pa'.
 *  @param q  the query graph Q(U, D, k)
 *  @param g  the data graph  G(V, E, l)
 */
class TightSim2 (g: Graph, q: Graph) 
      extends GraphMatcher (g, q)
{
     ...
     */
    def mappings2 (): HashMap [Int, Array [SET [Int]]] = tightSim (new DualSim2 (g, q).mappings ())
    ...
    def filterGraph (phi: Array [SET [Int]]): Graph = 
    {
        ...
        new Graph (newCh, g.label, q.inverse, g.name + "2")       // create a new data graph
    } // filterGraph
 ...
 *  > run-main scalation.graphalytics.TightSim2Test
 */
 ...
 */
object TightSim2Test2 extends App 
{
    val g = Graph.g2p
    val q = Graph.q2p
...
} // TightSim2Test2 object


//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `TightSim2Test3` object test the `TightSim2` class by passing data graph
 *  and query graph relative file paths.
 *  > run-main scalation.graphalytics.TightSim2Test3
 */
object TightSim2Test3 extends App 
{
    val g = GraphIO ("gfile")
    val q = GraphIO ("qfile")
