...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `DigGen2` object is used to build random graph with various characteristics.
 */
object DigGen2
{
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `DigGen2Test` object is used to test the `DigGen2` class
 *  for building random graphs where a vertex's degree is uniformly distributed.
 */
object DigGen2Test extends App
{
    import DigGen2._

    println ("DigGen2Test: test genRandomGraph")
    ...
    println ("DigGen2Test: test genRandomConnectedGraph")
    (0 until 10).foreach { _ =>
        val g = genRandomConnectedGraph (4, 100, 1)
        g.print ()
    } // foreach

    println ("DigGen2Test: test geneRandomGraph_PowLabels")
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `DigGen2Test2` object is used to test the `DigGen2` class
 *  for building power law graphs.
 */
object DigGen2Test2 extends App
{
    import DigGen2._

    println ("DigGen2Test2: test genPowerLawGraph")
    val g2 = genPowerLawGraph (50, 10, 10, 2.1)
    g2.print ()
    g2.ch.sortBy (_.size).foreach { println(_) }

    println ("DigGen2Test2: test genPowerLawGraph_PowLabels")
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `DigGen2Test3` object is used to test the `DigGen2` class
 *  for extracting query graphs from data graphs.
 */
object DigGen2Test3 extends App
{
    import DigGen2._
    ...
    println ("DigGen2Test3: test genBFSQuery")
