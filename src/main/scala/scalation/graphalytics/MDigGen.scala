...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `MDigGen` object is used to build random graph with various characteristics.
 */
object MDigGen
{
    ...
    def genPowerLawGraph (size: Int, nLabels: Int, maxDegree: Int, distPow: Double,
                          inverse: Boolean = false, name: String = "g"): MDigraph =
    {
        val ch = Array.ofDim [SET [Int]] (size)
        for (i <- ch.indices) {                                          // each vertex i
     ...
     *  @param name      the name of the graph
     */
    def genBFSQuery (size: Int, avDegree: Int, g: MDigraph, inverse: Boolean = false,
                     name: String = "g"): MDigraph =
    {
     ...
     *  @param name     the name of the graph
     */
    def extractSubgraph (size: Int, g: MDigraph, inverse: Boolean = false, name: String = "g"): MDigraph =
    {
        val maxRestarts = 5000
        var nRestarts   = 0
        var chMap: Map [Int, SET [Int]] = null
