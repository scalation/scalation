...
//      director.animate (this, CreateEdge, blue, QCurve (), from, to, Array (bend))
    ...
    def jump ()
    {
        ...
        curve.setTrajectory (0.5)                  // jump to middle of curve
...
//              println ("Transport.move: -- after  loc = " + loc)
        ...
        accum (onTransport)
        onTransport -= 1
        actor.setTrajectory (0.0)                 // reset for next transport
    } // move
