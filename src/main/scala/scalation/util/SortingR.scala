...
object SortingRTest extends App
{
    ...
    val rn = new Random ()
    val n  = 1000000
    val a  = Array [Real] (9, 1, 8, 2, 7, 3, 6, 4, 5)
    ...
    for (k <- 1 to 5) {
        val med = new SortingR (Array [Real] (9, 1, 8, 2, 7, 3, 6, 4, 5))
...
object SortingRTest2 extends App
{
    ...
    println ("--------------------------------------------------------------")
    val a1 = Array [Real] (9, 1, 8, 2, 7, 3, 6, 4, 5)
    ...
    println ("--------------------------------------------------------------")
    val a2 = Array [Real] (9, 1, 8, 2, 7, 3, 6, 4, 5)
    ...
    for (k <- 0 until 20) {
//      for (i <- 0 until n) aa(i) = rn.nextDouble ()
//      print ("quicksort:   "); time { quickSort (aa) }    // Scala's QuickSort, not for Real
        for (i <- 0 until n) aa(i) = rn.nextDouble ()
