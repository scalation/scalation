...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `SortingQTest` object is used to test the correctness and performance
 *  of the 'median' and 'imedian' methods in the `SortingQ` class.
 */
object SortingQTest extends App
{
    var md = _0
    val rn = new Random ()
    val n  = 1000000
    val a  = Array [Rational] (9, 1, 8, 2, 7, 3, 6, 4, 5)
    ...
    for (k <- 1 to 5) {
        val med = new SortingQ (Array [Rational] (9, 1, 8, 2, 7, 3, 6, 4, 5))
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `SortingQTest2` object is used to test the correctness and performance
 *  of the 'qsort' and 'iqsort' sorting methods in the `SortingQ` class.
 */
object SortingQTest2 extends App
{
    ...
    println ("--------------------------------------------------------------")
    val a1 = Array [Rational] (9, 1, 8, 2, 7, 3, 6, 4, 5)
    println ("Test direct: a1 = " + a1.deep)
    val srt = new SortingQ (a1)
    srt.qsort ()
    ...
    println ("--------------------------------------------------------------")
    val a2 = Array [Rational] (9, 1, 8, 2, 7, 3, 6, 4, 5)
    println ("Test indirect: a2 = " + a2.deep)
    val isrt = new SortingQ (a2)
    rk = isrt.iqsort ()
    ...
    for (k <- 0 until 20) {
//      for (i <- 0 until n) aa(i) = rn.nextLong ()
//      print ("quicksort:   "); time { quickSort (aa) }    // Scala's QuickSort, not for Rational
        for (i <- 0 until n) aa(i) = rn.nextLong ()
        val srt = new SortingQ (aa)
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `SortingQTest3` object is used to test the correctness and performance
 *  of the 'selsort' and 'iselsort' sorting methods in the `SortingQ` class.
 */
object SortingQTest3 extends App
{
    import scala.util.Sorting.quickSort
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `SortingQTest4` object is used to test the correctness and performance
 *  of the 'qsort2' and 'iqsort2' sorting methods in the `SortingQ` class.
 */
object SortingQTest4 extends App
{
    import scala.util.Sorting.quickSort
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `SortingQTest5` object is used to test the correctness and performance
 *  of the 'selsort2' and 'iselsort2' sorting methods in the `SortingQ` class.
 *  Thet sort in decreasing order.
 */
object SortingQTest5 extends App
{
    import scala.util.Sorting.quickSort
