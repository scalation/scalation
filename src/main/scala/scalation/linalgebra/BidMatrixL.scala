      ...
      extends MatriL with Error with Serializable
{
    ...
    def + (u: VectorL): BidMatrixL =
    {
        throw new NoSuchMethodException ("BidMatrixL does not support + with VectorL")
    } // +
...
object BidMatrixL extends Error
{
     ...
     */
    def apply (u: Array [VectorL], columnwise: Boolean = true): BidMatrixL =
    {
     ...
     */
    def apply (u: Vector [VectorL]): BidMatrixL =
    {
        val u_dim = u(0).dim
