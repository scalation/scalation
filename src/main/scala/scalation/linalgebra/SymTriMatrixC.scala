      ...
      extends MatriC with Error with Serializable
{
    ...
    {
        throw new NoSuchMethodException ("SymTriMatrixC does not support + for VectorC")
    } // +
     ...
     */
    def dot (u: VectorC): VectorC = this * u
...
object SymTriMatrixC extends Error
{
     ...
     */
    def apply (u: Array [VectorC], columnwise: Boolean = true): SymTriMatrixC =
    {
     ...
     */
    def apply (u: Vector [VectorC]): SymTriMatrixC =
    {
        val u_dim = u(0).dim
