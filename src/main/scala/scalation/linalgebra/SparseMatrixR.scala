      ...
      extends MatriR with Error with Serializable
{
     ...
     */
    def this (dim: Tuple2 [Int, Int], u: Real*)
    {
        this (dim._1, dim._2)
...
//  } // constructor
    ...
    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Convert 'this' Sparse`MatrixR` into a `MatrixI`.
     */
    def toInt: MatrixI =
    {
     ...
     */
    def dot (b: MatriR): SparseMatrixR =
    {
     ...
     *  partial pivoting.
     */
    def lud: Tuple2 [SparseMatrixR, SparseMatrixR] =
    {
        val l = new SparseMatrixR (dim1, dim2)   // lower triangular matrix
     ...
     */
    def lud_ip (): Tuple2 [SparseMatrixR, SparseMatrixR] =
    {
        val l = new SparseMatrixR (dim1, dim2)   // lower triangular matrix
     ...
     *  @param b  the constant vector.
     */
    def solve (b: VectoR): VectorR = solve (lud, b)
