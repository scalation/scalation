      ...
      extends MatriI with Error with Serializable
{
    ...
    {
        throw new NoSuchMethodException ("SymTriMatrixI must be symmetric")
    } // slice
    ...
    {
        throw new NoSuchMethodException ("SymTriMatrixI does not support sliceExclude")
    } // sliceExclude
    ...
    {
        throw new NoSuchMethodException ("SymTriMatrixI does not support selectRows")
    } // selectRows
    ...
    {
        throw new NoSuchMethodException ("SymTriMatrixI does not support selectCols")
    } // selectCols
     ...
     */
    def +: (u: VectorI): SymTriMatrixI =
    {
        throw new NoSuchMethodException ("SymTriMatrixI does not support +:")
    } // +:
    ...
    {
        throw new NoSuchMethodException ("SymTriMatrixI does not support + for VectorI")
    } // +
    ...
    def * (b: MatriI): SymTriMatrixI = 
    {
        throw new NoSuchMethodException ("SymTriMatrixI does not support * with general matrices")
    } // *
     ...
     */
    def dot (u: VectorI): VectorI = this * u
    ...
    def solve (l: MatriI, u: MatriI, b: VectorI): VectorI = 
    {
        ...
        val ll = l.asInstanceOf [MatrixI]
        val uu = u.asInstanceOf [MatrixI]
        ll.solve (uu, b)
    } // solve
    ...
    def solve (b: VectorI): VectorI =
    {
        ...
        val d = _dg                           // diagonal
        val e = new VectorI (_sd  ++ 0)     // augmented superdiagonal
     ...
     */
    def sumAbs: Int = _dg.sumAbs + _sd.sumAbs + _sd.sumAbs
...
object SymTriMatrixI extends Error
{
     ...
     */
    def apply (u: Array [VectorI], columnwise: Boolean = true): SymTriMatrixI =
    {
     ...
     */
    def apply (u: Vector [VectorI]): SymTriMatrixI =
    {
        val u_dim = u(0).dim
