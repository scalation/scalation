      ...
      extends MatriQ with Error with Serializable
{
     ...
     */
    def this (v1: VectorQ, v2: VectorQ)
    {
        this (v1.dim)
    ...
    {
        throw new NoSuchMethodException ("SymTriMatrixQ does not support + for VectorQ")
    } // +
     ...
     */
    def dot (u: VectorQ): VectorQ = this * u
...
object SymTriMatrixQ extends Error
{
     ...
     */
    def apply (u: Array [VectorQ], columnwise: Boolean = true): SymTriMatrixQ =
    {
     ...
     */
    def apply (u: Vector [VectorQ]): SymTriMatrixQ =
    {
        val u_dim = u(0).dim
