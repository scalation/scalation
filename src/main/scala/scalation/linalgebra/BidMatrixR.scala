      ...
      extends MatriR with Error with Serializable
{
    ...
    {
        throw new NoSuchMethodException ("values for BidMatrixR should be diagonal")
    } // set
    ...
    {
        throw new NoSuchMethodException ("BidMatrixR must be square")
    } // slice
    ...
    {
        throw new NoSuchMethodException ("BidMatrixR does not support sliceExclude")
    } // sliceExclude
    ...
    {
        throw new NoSuchMethodException ("BidMatrixR does not support selectRows")
    } // selectRows
    ...
    {
        throw new NoSuchMethodException ("BidMatrixR does not support selectCols")
    } // selectCols
    ...
    def t: BidMatrixR =
    {
        throw new NoSuchMethodException ("BidMatrixR does not support transpose")
    } // t
     ...
     */
    def +: (u: VectorR): BidMatrixR =
    {
        throw new NoSuchMethodException ("BidMatrixR does not support +:")
    } // +:
    ...
    def + (u: VectorR): BidMatrixR =
    {
        throw new NoSuchMethodException ("BidMatrixR does not support + with VectorR")
    } // +
    ...
    def * (b: MatriR): BidMatrixR = 
    {
        throw new NoSuchMethodException ("BidMatrixR does not support * with general matrices")
    } // *
     ...
     */
    def sumAbs: Real = _dg.sumAbs + _sd.sumAbs
...
object BidMatrixR extends Error
{
     ...
     */
    def apply (u: Array [VectorR], columnwise: Boolean = true): BidMatrixR =
    {
     ...
     */
    def apply (u: Vector [VectorR]): BidMatrixR =
    {
        val u_dim = u(0).dim
