...
object SparseMatrixQ
{
     ...
     */
    def apply (u: Array [VectorQ], columnwise: Boolean = true): SparseMatrixQ =
    {
     ...
     */
    def apply (u: Vector [VectorQ]): SparseMatrixQ =
    {
        val u_dim = u(0).dim
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `SparseMatrixQ` class stores and operates on Matrices of Rationals.  Rather
      ...
      extends MatriQ with Error with Serializable
{
     ...
     */
    def setCol (col: Int, u: VectorQ) { for (i <- range1) this(i, col) = u(i) }
     ...
     *  partial pivoting.
     */
    def lud: Tuple2 [SparseMatrixQ, SparseMatrixQ] =
    {
        val l = new SparseMatrixQ (dim1, dim2)   // lower triangular matrix
     ...
     */
    def lud_ip: Tuple2 [SparseMatrixQ, SparseMatrixQ] =
    {
        val l = new SparseMatrixQ (dim1, dim2)   // lower triangular matrix
...
object SparseMatrixQTest extends App
{
    ...
    for (l <- 1 to 4) {
        println ("\n\tTest SparseMatrixQ on real matrices of dim " + l)
        val x = new SparseMatrixQ (l, l)
        val y = new SparseMatrixQ (l, l)
        x.set (2)
        y.set (3)
        println ("x + y = " + (x + y))
        println ("x - y = " + (x - y))
    ...
    println ("\n\tTest SparseMatrixQ on additional operations")
