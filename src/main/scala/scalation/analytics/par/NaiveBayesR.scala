 ...
 *  densities.  This version uses parallel processing to speed up execution.
 *-----------------------------------------------------------------------------
 ...
 ** Classify whether a person is male (M) or female (F) based on the measured features.
 *  @see http://en.wikipedia.org/wiki/Naive_Bayes_classifier
 *  > run-main scalation.analytics.par.NaiveBayesRTest
 */
