...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `Tester` trait servers as a template for unit testing of class `KLASS`.
 ...
 *  For performance, it compares the results of the method/operator 'call' to the 'oracle'
 *  and an optional 'contender'.  The 'contender' need not produce identical results.
 *------------------------------------------------------------------------------
...
trait Tester
{
    ...
    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Test a method/operator from class `T`.
    ...
    def test (name: String, call: => Any, oracle: => Any, contender: => Any = null)
    {
        ...
        for (it <- 0 until ITER) {
            ...
            if (CORRECT) {
                ...
                if (contender != null) t_contender += guage { contender }
            } // if
        } // for
