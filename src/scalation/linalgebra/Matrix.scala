 ...
 *  implemeting classes: MatrixD, SparseMatrixD and SymTriMatrixD.
 */
trait Matrix
      extends Error
{
     ...
     *  @param x  the scalar value to assign
     */
    def set (x: Double) { for (i <- range1; j <- range2) this(i, j) = x }

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Set all the lower triangular elements in this matrix to the scalar x.
     *  @param x  the scalar value to assign
     */
    def setLower (x: Double) { for (i <- range1; j <- 0 until i) this(i, j) = x }

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Set the values in this matrix as copies of the values in 2D array u.
     *  @param u  the 2D array of values to assign
     */
    def set (u: Array [Array [Double]]) { for (i <- range1; j <- range2) this(i, j) = u(i)(j) }
...
*/
     ...
     */
    def setRow (row: Int, u: VectorD) { for (j <- range2) this(row, j) = u(j) }
...
*/
     ...
     */
    def setDiag (s: Double) { for (i <- range1) this(i, i) = s }
