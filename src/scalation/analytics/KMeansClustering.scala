...
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** Cluster several vectors/points using k-means clustering.  Either (1) randomly
 *  assign points to k clusters or (2) randomly pick k points as initial centroids
 *  (technique (1) to work better and is the primary technique).  Iteratively,
 *  reassign each point to the cluster containing the closest centroid.  Stop when
 *  there are no changes to the clusters.
