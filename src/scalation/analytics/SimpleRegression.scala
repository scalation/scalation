...
object SimpleRegressionTest extends App
{
    ...
    val x = new MatrixD ((5, 2), 1.0, 0.0,           // 5-by-2 matrix
                                 ...
                                 1.0, 3.0,
                                 1.0, 4.0)
    val y = new VectorD (2.0, 3.0, 5.0, 4.0, 6.0)
    ...
    val z  = new VectorD (1.0, 5.0)           // predict y for one point
    val yp = rg.predict (z)
...
object SimpleRegressionTest2 extends App
{
    ...
    val x1 = new VectorD (  4.0,   9.0,  10.0,  14.0,   4.0,   7.0,  12.0,  22.0,   1.0,   3.0,
                            8.0,  11.0,   5.0,   6.0,  10.0,  11.0,  16.0,  13.0,  13.0,  10.0)
    val y  = new VectorD (390.0, 580.0, 650.0, 730.0, 410.0, 530.0, 600.0, 790.0, 350.0, 400.0,
    ...
    val z  = new VectorD (1.0, 15.0)          // predict y for one point
    val yp = rg.predict (z)
    println ("predict (" + z + ") = " + yp)
