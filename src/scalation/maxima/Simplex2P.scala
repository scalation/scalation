...
object Simplex2PTest extends App
{
    ...
    def test1 ()
    {
        val a = new MatrixD ((5, 3), -1.0,  1.0,  0.0,
                                      ...
                                      3.0, -4.0,  0.0,
                                      0.0,  0.0,  1.0)
        val c = new VectorD          (1.0,  1.0,  1.0)
        val b = new VectorD (5.0, 45.0, 27.0, 24.0, 4.0)
        test (a, b, c)
    } // test1
    ...
    def test2 ()
    {
        val a = new MatrixD ((3, 2),  5.0, 15.0,
                                      4.0,  4.0,
                                     35.0, 20.0)
        val c = new VectorD        ( 13.0, 23.0)
        val b = new VectorD (480.0, 160.0, 1190.0)
        test (a, b, c)
    } // test2
    ...
    def test3 ()
    {
        val a = new MatrixD ((3, 4), .5,  -5.5, -2.5,   9.0,
                                     .5,  -1.5, -0.5,   1.0,
                                    1.0,   0.0,  0.0,   0.0)
        val c = new VectorD       (10.0, -57.0, -9.0, -24.0)
        val b = new VectorD ( 0.0,   0.0,  1.0)
        test (a, b, c)
    } // test3
    ...
    def test4 ()
    {
        val a = new MatrixD ((2, 4), -2.0, -9.0,  1.0,   9.0,
                                      1.0,  1.0, -1.0,  -2.0)
        val c = new VectorD          (2.0,  3.0, -1.0, -12.0)
        val b = new VectorD (3.0, 2.0)
        test (a, b, c)
    } // test4
    ...
    def test5 ()
    {
        val a = new MatrixD ((2, 2),  2.0, 3.0,
                                      2.0, 0.0)
        val c = new VectorD          (1.0, 2.0)
        val b = new VectorD (16.0, -8.0)
        test (a, b, c)
    } // test5 ()
    ...
    def test6 ()
    {
        ...
        val b = new VectorD (6.0, 45.0, 1.0, -5)
        test (a, b, c)
    } // test6 ()
