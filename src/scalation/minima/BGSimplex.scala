 ...
 *
 *  @see http://www.cise.ufl.edu/research/sparse/Morgan/bg.htm
 *  @see http://www.cise.ufl.edu/research/sparse/Morgan/chapter2.htm
 */
...
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** This class solves Linear Programming (LP) problems using the Bartels-Golub
 ...
 */
class BGSimplex (a: MatrixD, b: VectorD, c: VectorD, var x_B: Array [Int] = null)
      extends MinimizerLP
{
 ...
 */
object BGSimplexTest extends App
{
    //:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    ...
    {
//      val lp = new BGSimplex (a, b, c, x_B)    // test with user specified basis
        val lp = new BGSimplex (a, b, c)         // test with default basis
     ...
     *  an identity matrix and vector 'c' augmented with zeroes.
     *-------------------------------------------------------------------------
