...
object UpVersion
{
    private val pat1       = "@version 1.1"            // pattern to find (change as needed)
    private val pat2       = "@version 1.2"            // replacement pattern (change as needed
    ...
    private val BASE_DIR   = ".."                      // base directory
    private val SRC_DIR    = BASE_DIR + sep + "src"    // source directory
