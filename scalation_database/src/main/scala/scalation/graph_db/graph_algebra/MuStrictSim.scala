...
import scalation.graph_db.pattern_matching.{Ball, GraphMatcher}
import scalation.graph_db.GraphMetrics
import scalation.stat.Statistic

import MuGraph.ν

//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `MuStrictSim` class provides an implementation for strict simulation
 *  graph pattern matching.  This version uses `DualSim`.
 *  @see hipore.com/ijbd/2014/IJBD%20Vol%201%20No%201%202014.pdf
 *  @param q  the query graph Q(U, D, k)
 *  @param g  the data graph  G(V, E, l)
 */
class MuStrictSim [TLabel: ClassTag] (g: MuGraph [TLabel], q: MuGraph [TLabel]) 
      extends GraphMatcher (g, q)
{
     ...
     */ 
    override def filterGraph (phi: Array [SET [Int]]): MuGraph [TLabel] =
    {
...
object MuStrictSimTest extends App
{
    ...
    val matcher = new MuStrictSim (g, q)                         // Strict Graph Simulation Pattern Matcher
    matcher.test ("MuStrictSim")

} // MuStrictSimTest object
...
object MuStrictSimTest2 extends App 
{
    ...
    val matcher = new MuStrictSim (g, q)                         // Strict Graph Simulation Pattern Matcher
    matcher.test ("MuStrictSim", shift (strictSim))

} // MuStrictSimTest2 object
...
/*object MuStrictSimTest3 extends App 
{
    ...
    (new MuStrictSim (g, q)).test ("MuStrictSim")   // Strict Graph Simulation Pattern Matcher
