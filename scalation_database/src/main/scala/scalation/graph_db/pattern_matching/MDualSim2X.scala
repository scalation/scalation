 ...
 *  order to save space.  This version also supports regex.
 *  @param g  the data graph  G(V, E, l)
 *  @param q  the query graph Q(U, D, k)
 */
class MDualSim2X [TLabel: ClassTag] (g: MGraph [TLabel], q: MGraph [TLabel])
...
object MDualSim2XTest extends App
{
    ...
    (new MDualSim2X (g, q)).test ("MDualSim2X")    // Dual Graph Simulation Pattern Matcher

} // MDualSim2XTest object
